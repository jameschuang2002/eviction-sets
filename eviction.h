...
// How many bits [6,10] to match between the victim cache set and the cache set of new cache lines
...
// A CacheLine is a contiguous region of memory with pointers to other CacheLines
